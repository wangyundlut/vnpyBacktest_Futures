...
if __name__ == '__main__':
    ...
    # 设置回测用的数据起始日期,起始日期十天
    engine.setStartDate('2019-04-03', 10)
    ...
    # 提取K线数据,
    time, data, vol = vnpy_view.kline_data_get("min_01")
    # 画K线
    ...
    page.add(l_3)
    page.add(bar_1)
    page.render("atrrsi.html")

    vnpy_view.saveResult("atrrsi.xlsx")
